...
public class SCPGuiName extends GuiScreen
{
	...
	public void initGui()
	{
		try
		{
			img = ModLoader.loadImage(mc.renderEngine, "/SCPCraft/textures/guis/Naming.png");
	...
	public void drawScreen(int i, int j, float f)
	{
		...
		try
		{
			int tempvar = mc.renderEngine.getTexture("/SCPCraft/textures/guis/Naming.png");
			GL11.glColor4f(1.0F, 1.0F, 1.0F, 1.0F);
			mc.renderEngine.bindTexture("/SCPCraft/textures/guis/Naming.png");
