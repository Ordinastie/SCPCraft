...
public class SCPEntity457 extends SCPEntity
{
	...
	{	
		...
		tasks.addTask(0, new EntityAIAttackOnCollide(this, EntityPlayer.class, moveSpeed, false));
        tasks.addTask(1, new EntityAIWander(this, moveSpeed));
        tasks.addTask(2, new EntityAIAttackOnCollide(this, EntityLiving.class, this.moveSpeed, true));
