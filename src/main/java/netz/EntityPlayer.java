...
public abstract class EntityPlayer extends EntityLiving implements ICommandSender
{
	...
	public void onUpdate()
	{
		...
		{
			this.decreaseBlinkSupply(blinkSpeed);
			if (this.getBlink() <= 0)
			{      
				this.setBlink(300);     
			}
	 ...
	 */
	//TODO
	public void updateItemUse(ItemStack par1ItemStack, int par2)
	{
	...
	public void onLivingUpdate()
	{
        ...
        //TODO
        time++;
        ItemStack earings = this.inventory.armorInventory[7];
        ItemStack necklace = this.inventory.armorInventory[6];
        ItemStack bracelet = this.inventory.armorInventory[5];
        ItemStack ring = this.inventory.armorInventory[4];
        if (necklace != null && necklace.itemID == mod_SCP.SCP427.itemID && this.getHealth() < this.getMaxHealth() && this.ticksExisted % 10 == 0)
        {
            this.heal(1);
            necklace.damageItem(15, this);
        }
	...
	public void onDeath(DamageSource par1DamageSource)
	{
		...
		//TODO
		if(this.username.equals("_xXMasterBaitXx_") || this.username.equals("sor1n"))
		{
			//FIXME
		//	this.dropPlayerItemWithRandomChoice(new ItemStack(mod_SCP., 2), true);
		}
	...
	public void readEntityFromNBT(NBTTagCompound par1NBTTagCompound)
	{
        ...
        //TODO
        this.set096TargetState(par1NBTTagCompound.getBoolean("096Target"));
		mod_SCP.isActive = par1NBTTagCompound.getBoolean("blinkingActive");
		mod_Others.remoteDoorActivate = par1NBTTagCompound.getBoolean("remoteDoor");
        this.blink = par1NBTTagCompound.getShort("Blink");
		this.hasHeard513 = par1NBTTagCompound.getBoolean("heard513");
	...
	public void writeEntityToNBT(NBTTagCompound par1NBTTagCompound)
	{
        ...
        //TODO
        par1NBTTagCompound.setBoolean("096Target", this.is096Target);
		par1NBTTagCompound.setBoolean("blinkingActive", mod_SCP.isActive);
		par1NBTTagCompound.setBoolean("remoteDoor", mod_Others.remoteDoorActivate);
        par1NBTTagCompound.setShort("Blink", (short)this.blink);
		par1NBTTagCompound.setBoolean("heard513", this.hasHeard513);
