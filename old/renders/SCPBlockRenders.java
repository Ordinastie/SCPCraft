...
public class SCPBlockRenders implements ISimpleBlockRenderingHandler
{
	...
	public boolean renderDesk(SCPBlockDesk block, int i, int j, int k, RenderBlocks renderblocks)
	{
		boolean flag = block.canThisPaneConnectToThisBlockID(renderblocks.blockAccess.getBlockId(i, j, k - 1));
		boolean flag1 = block.canThisPaneConnectToThisBlockID(renderblocks.blockAccess.getBlockId(i - 1, j, k));
		boolean flag2 = block.canThisPaneConnectToThisBlockID(renderblocks.blockAccess.getBlockId(i + 1, j, k));
	...
	public boolean renderBlockChairInWorld(RenderBlocks renderblocks, IBlockAccess iblockaccess, int i, int j, int k, Block block)
	{
		int side = iblockaccess.getBlockMetadata(i, j, k) & 0x3;
		setBlockBoundsWithRotation(renderblocks, block, 0.1F, 0.0F, 0.1F, 0.2F, 0.5F, 0.2F, side);
		renderblocks.renderStandardBlock(block, i, j, k);
		setBlockBoundsWithRotation(renderblocks, block, 0.1F, 0.0F, 0.8F, 0.2F, 0.5F, 0.9F, side);
		renderblocks.renderStandardBlock(block, i, j, k);
		setBlockBoundsWithRotation(renderblocks, block, 0.8F, 0.0F, 0.8F, 0.9F, 0.5F, 0.9F, side);
		renderblocks.renderStandardBlock(block, i, j, k);
		setBlockBoundsWithRotation(renderblocks, block, 0.8F, 0.0F, 0.1F, 0.9F, 0.5F, 0.2F, side);
		renderblocks.renderStandardBlock(block, i, j, k);
		setBlockBoundsWithRotation(renderblocks, block, 0.1F, 0.5F, 0.1F, 0.9F, 0.6F, 0.9F, side);
		renderblocks.renderStandardBlock(block, i, j, k);
		setBlockBoundsWithRotation(renderblocks, block, 0.1F, 0.6F, 0.1F, 0.2F, 1.5F, 0.9F, side);
		renderblocks.renderStandardBlock(block, i, j, k);
		return true;
	}
