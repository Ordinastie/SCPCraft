...
public class EntitySCP131 extends EntityTameable
{
	public EntitySCP131(World par1World)
	{
		super(par1World);
		setSize(0.9F, 1.3F);
		...
		tasks.addTask(7, new EntityAIAttackOnCollide(this, EntitySCP173.class, 1.0D, false));
		tasks.addTask(8, new EntityAIWander(this, 0.23F));
		tasks.addTask(9, new EntityAIWatchClosest(this, EntityPlayer.class, 10F));
		tasks.addTask(10, new EntityAIWatchClosest(this, EntityClassDGuy.class, 10F));
		tasks.addTask(11, new EntityAIWatchClosest(this, EntitySCP173.class, 10F));
		targetTasks.addTask(1, new EntityAIOwnerHurtByTarget(this));
		targetTasks.addTask(2, new EntityAIOwnerHurtTarget(this));
		targetTasks.addTask(3, new EntityAIHurtByTarget(this, true));
		tasks.addTask(0, new EntityAITempt(this, 0.25F, Item.ingotGold.itemID, false));
		targetTasks.addTask(4, new EntityAINearestAttackableTarget(this, EntitySCP173.class, 0, true));
	}
	...
	{
		return new EntitySCP131(worldObj);
	}
