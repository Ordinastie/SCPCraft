...
//	public static final Item Pearl1440 = (new SCPItemPearl(6025, "SCP-1440").26).setUnlocalizedName("SCP-1440"));
	...
	public static final Achievement classDshirt = (new Achievement(1005, "classDShirt", -1, 2, ClassDShirt, reinforcedIron)).registerAchievement();
	public static final Achievement classDpants = (new Achievement(1006, "classDPants", -2, 2, ClassDPants, classDshirt)).registerAchievement();
	public static final Achievement classDboots = (new Achievement(1007, "classDBoots", -3, 2, ClassDShoes, classDpants)).registerAchievement();
