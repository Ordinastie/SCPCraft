...
public class SCPBlockChair extends Block
{
    ...
    public void onBlockPlacedBy(World par1World, int par2, int par3, int par4, EntityLiving par5EntityLiving, ItemStack par6ItemStack)
    {
        ...
        if (i == 0)
        {
            par1World.setBlockMetadataWithNotify(par2, par3, par4, 1 | j, 0x02);//
        }
        else if (i == 1)
        {
            par1World.setBlockMetadataWithNotify(par2, par3, par4, 0 | j, 0x02);//
        }
        else if (i == 2)
        {
            par1World.setBlockMetadataWithNotify(par2, par3, par4, 3 | j, 0x02);//
        }
        else if (i == 3)
        {
            par1World.setBlockMetadataWithNotify(par2, par3, par4, 2 | j, 0x02); //
        }
    }
