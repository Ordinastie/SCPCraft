...
public class SCPEntity217Zombie extends SCPEntity
{
    ...
    public SCPEntity217Zombie(World par1World)
    {
        ...
        tasks.addTask(3, new EntityAIAttackOnCollide(this, SCPEntity217Testificate.class, this.moveSpeed, true));
        tasks.addTask(3, new EntityAIAttackOnCollide(this, EntityVillager.class, this.moveSpeed, true));
