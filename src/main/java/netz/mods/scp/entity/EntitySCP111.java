...
public class EntitySCP111 extends EntityAnimal
{
	private final EntityAIControlledByPlayer aiControlledByPlayer;

	public EntitySCP111(World par1World)
	{
		super(par1World);
		...
		this.tasks.addTask(4, new EntityAITempt(this, 0.3F, Items.apple, false));
	 ...
	 */
	public EntitySCP111 spawnBabyAnimal(EntityAgeable par1EntityAgeable)
	{
		return new EntitySCP111(this.worldObj);
	}
	...
	{
		return par1ItemStack != null && par1ItemStack.getItem() instanceof Items.apple;
	}
