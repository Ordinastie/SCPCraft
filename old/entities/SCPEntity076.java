...
public class SCPEntity076 extends SCPEntity
{
	...
	public SCPEntity076(World par1World)
	{
		...
		this.tasks.addTask(2, new EntityAIAttackOnCollide(this, SCPEntity073.class, this.moveSpeed, true));
		this.tasks.addTask(2, new EntityAIAttackOnCollide(this, EntityPlayer.class, this.moveSpeed, true));
        this.tasks.addTask(2, new EntityAIAttackOnCollide(this, EntityLiving.class, this.moveSpeed, true));
